...
const IndividualFeatures= ({ imageUrl,title,description }) => {
  return (
    <div className='w-[90vw] lg:w-[50%] h-fit lg:h-[40vh]  pt-3 pl-3   group hover:shadow-lg  transition-shadow duration-300   hover:shadow-gray-600 cursor-pointer  bg-[#FFFFFF] rounded-xl'>
      ...
      <img className='cursor-pointer w-[300px] lg:w-[450px] h-8 lg:h-12 ' src={imageUrl}  alt='image' />
    ...
    <div className='w-full min-h-[100vh] bg-[#F5EDE9]'>
        ...
        <div className='w-full min-h-[50vh] bg-[#F5EDE9] mt-5  pl-5 lg:pb-5 lg:pl-2 lg:pr-2 flex flex-col pr-10 '>
          <div className='w-full  h-fit flex flex-col gap-5 md:flex-row  lg:pr-2'>
             <IndividualFeatures  imageUrl="https://kinsta.com/wp-content/uploads/2023/11/headless-label-min-1024x101.png" title="Headless WordPress"  description="Use the longest standing content management system with your cutting edge frontend."/>
             <IndividualFeatures  imageUrl="https://kinsta.com/wp-content/uploads/2023/11/staging-label-min-1024x101.png" title="WordPress as a static site" description="Render your complete WordPress site into static assets, giving unparalleled speed and inherent security." />
          </div>

          <div className='w-full  h-fit flex flex-col mt-5 gap-5 pt-5 lg:pt-0 md:flex-row '>
             <IndividualFeatures  imageUrl="https://kinsta.com/wp-content/uploads/2023/11/Extended-solutions-label-min-1024x101.png" title="Extend with custom solutions" description="It can be a WordPress plugin with its own functions and database, or something running besides your site core." />
             <IndividualFeatures  imageUrl="https://kinsta.com/wp-content/uploads/2023/11/microservice-label-min-1024x101.png" title="Microservice architecture" description="WordPress doesn’t have to be a monolith either, compartmentalize any function into a separate app." />
          </div>
