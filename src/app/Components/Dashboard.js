...
const Dashboard = () => {
  return (
    <div className='w-full min-h-[100vh] '>
          <Image className=' rounded-3xl mx-auto mb-10  mt-10 border-8  border-[#45241f7e]  shadow-[0px_0px_15px_2px_#fefefe] ' src="/dashboard.png" alt='home-icon' width={850} height={850}/>
